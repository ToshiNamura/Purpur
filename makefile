...
build-1.16.5-1171:
	docker build . -f ./Purpur-1.16.5-1171/dockerfile -t microclock64/purpur:1.16.5-1171

run-1.16.5-1171:
	docker run -d --name purpur-1-16-5-1171-server -p 25570:25565 -v purpur-1-16-5-1171-data:/purpur microclock64/purpur:1.16.5-1171

1.16.5-1171: build-1.16.5-1171 run-1.16.5-1171

# Global::

build-all: build-1.16.5-1171 build-1.17.1-1428 build-1.18.2-1632 build-1.19.4-1985 build-1.20.2-2095

set-latest:
	docker tag microclock64/purpur:1.16.5-1171 microclock64/purpur:1.16.5
